...
const styles: Record<string, React.CSSProperties> = {
  ...
  section: { padding: "9px 12px", borderBottom: "1px solid rgba(148,163,184,.12)" },
  sectionTitle: {
    display: "flex",
    alignItems: "center",
    gap: 8,
  ...
  twoColumnGrid: { display: "grid", gridTemplateColumns: "repeat(2, minmax(0, 1fr))", gap: 8 },
  fieldLabel: { display: "grid", gap: 4, minWidth: 0 },
  fieldName: { color: "#94a3b8", fontSize: 10, fontWeight: 600 },
  ...
  rangeLabel: { display: "grid", gap: 5 },
  rangeHeader: { display: "flex", justifyContent: "space-between", color: "#94a3b8", fontSize: 10 },
  ...
  helperText: { margin: 0, color: "#64748b", fontSize: 10, lineHeight: 1.45 },
  emptyState: {
    display: "grid",
    placeItems: "center",
    alignContent: "center",
